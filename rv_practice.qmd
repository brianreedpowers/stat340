...
## 11. Functions of a random variable
...
## 13. Discrete Random Variable Problems
...
21. Let $X$ be a Gaussian random variable with $\mu=5$ and $\sigma^2=16$.
